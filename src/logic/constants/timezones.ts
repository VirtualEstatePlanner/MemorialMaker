import ITimeZone from '~/logic/model/ITimeZone'
...
const timezones: ITimeZone[] = [
  ...
  },
  {
    ...
    offset: 0,
    isDaylightSavingsTime: false,
    description: '(UTC) Edinburgh, London',
  ...
  },
  {
    ...
    offset: 1,
    isDaylightSavingsTime: true,
    description: '(UTC+01:00) Edinburgh, London',
    utc: ['Europe/Isle_of_Man', 'Europe/Guernsey', 'Europe/Jersey', 'Europe/London'],
  },
  {
    name: 'GMT Standard Time',
  ...
  },
  {
    ...
    offset: 3,
    isDaylightSavingsTime: false,
    description: '(UTC+03:00) Moscow, St. Petersburg, Volgograd, Minsk',
  ...
  },
  {
    ...
    offset: 4,
    isDaylightSavingsTime: false,
    description: '(UTC+04:00) Samara, Ulyanovsk, Saratov',
  ...
  },
  {
    ...
    offset: 6,
    isDaylightSavingsTime: false,
    description: '(UTC+06:00) Nur-Sultan (Astana)',
