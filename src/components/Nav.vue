    ...
    <li>
      <NuxtLink to="/">
        <span class="icon">
          ...
          /></svg>
        </span><span class="menu">Home</span>
      </NuxtLink>
    </li>
    <li>
      <NuxtLink to="/services">
        <span class="icon">
          ...
          /></svg>
        </span><span class="menu">Services</span>
      </NuxtLink>
    </li>
    <li>
      <NuxtLink to="/livestreams">
        <span class="icon">
          ...
          /></svg>
        </span><span class="menu">Livestreams</span>
      </NuxtLink>
    </li>
    <li>
      <NuxtLink to="/gallery">
        <span class="icon">
          ...
          /></svg>
        </span><span class="menu">Photo Gallery</span>
      </NuxtLink>
    </li>
    <li>
      <NuxtLink to="/charities">
        <span class="icon">
          <svg
          ...
          /></svg>
        </span><span class="menu">Charities</span>
      </NuxtLink>
    </li>
  </ul>
</template>
